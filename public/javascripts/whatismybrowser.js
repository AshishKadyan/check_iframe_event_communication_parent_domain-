var WIMB = WIMB || {
    ...
    meta_string: function () {
        return "href=" + encodeURIComponent(window.location.href) + "&wimb_version=" + WIMB.version;
    },
    init: {
    ...
    detect: {
        ...
        cookies_third_party: {
            ...
            trigger_set_cookie: function (e) {
                return (
                    ...
                    (window.wimb.data.cookies_third_party = "unknown"),
                    (cookie_set_script_element_id = "set_cookie"),
                    (e = (e = void 0 !== e ? e : "//webbrowsertests.com/detect/are-third-party-cookies-enabled-set-cookie") + "?" + WIMB.meta_string()),
                    (cookie_set_script_element = document.createElement("script")),
                    cookie_set_script_element.setAttribute("src", e),
                    cookie_set_script_element.setAttribute("id", cookie_set_script_element_id),
                    cookie_set_script_element.setAttribute("async", "async"),
                    (body_object = document.getElementsByTagName("body")[0]),
                    body_object.appendChild(cookie_set_script_element),
                    null !== document.getElementById(cookie_set_script_element_id)
                );
            },
            cookie_has_now_been_set_by_third_party: function (e) {
                (e = (e = void 0 !== e ? e : "//webbrowsertests.com/detect/are-third-party-cookies-enabled-check-cookie") + "?" + WIMB.meta_string()),
                    (cookie_check_script_element = document.createElement("script")),
                    cookie_check_script_element.setAttribute("src", e),
                    cookie_set_script_element.setAttribute("id", "check_cookie"),
                    (body_object = document.getElementsByTagName("body")[0]),
        ...
        flash: {
                ...
                if (s && "object" == typeof s[r]) {
                    ...
                    try {
                        if ((t = new ActiveXObject("ShockwaveFlash.ShockwaveFlash")) && (e = t.GetVariable("$version")))
                            return (e = e.split(" ")[1].split(",")), (playerVersion = [parseInt(e[0], 10), parseInt(e[1], 10), parseInt(e[2], 10)]), playerVersion;
                    } catch (e) {}
                return !1;
            },
            enabled: function () {
            ...
            version_major: function () {
                return (version_array = WIMB.detect.flash.version_array()), !1 !== version_array && version_array[0];
            },
            version_full: function () {
                return (version_array = WIMB.detect.flash.version_array()), !1 !== version_array && version_array[0] + "." + version_array[1] + "." + version_array[2];
            },
            version: function () {
                return (version_array = WIMB.detect.flash.version_array()), !1 !== version_array && version_array[0] + "." + version_array[1];
            },
        },
        java: {
            _get_version_string: function () {
                WIMB.init.namespace_the_window(),
                    window.wimb.deployJava ||
                        (window.wimb.deployJava = (function () {
                            var e = {
                                ...
                                o = (e.object.concat(e.core, e.i18n, e.events), e.applet.concat(e.core));
                            function d(e) {
                            ...
                            var t = {
                                ...
                                getJREs: function () {
                                    var e = new Array();
                                    if (this.isPluginInstalled()) for (var t = this.getPlugin().jvms, i = 0; i < t.getLength(); i++) e[i] = t.get(i).version;
                                    else {
                                              ...
                                              null != this.firefoxJavaVersion
                                                  ...
                                                  : "Safari" == this.browserName2 &&
                                                    (this.testUsingPluginsArray("1.7.0")
                                                        ...
                                                        ? (e[0] = "1.5.0")
                                                        : this.testUsingPluginsArray("1.4.2") && (e[0] = "1.4.2")));
                                    }
                                    if (this.debug) for (i = 0; i < e.length; ++i) d("[getJREs()] We claim to have detected Java SE " + e[i]);
                                    return e;
                                },
                                installJRE: function (e, t) {
                                    if (this.isPluginInstalled() && this.isAutoInstallEnabled(e)) {
                                        var i = !1;
                                        return (
                                            (i = this.isCallbackSupported() ? this.getPlugin().installJRE(e, t) : this.getPlugin().installJRE(e)) && (this.refresh(), null != this.returnPage && (document.location = this.returnPage)), i
                                        );
                                    }
                                        ...
                                        "MSIE" != deployJava.browserName ||
                                            ...
                                            (null != t &&
                                                !(function (e, t) {
                                                    ...
                                                    if (("+" != i && "*" != i && -1 != e.indexOf("_") && "_" != i && ((e += "*"), (i = "*")), 0 < (e = e.substring(0, e.length - 1)).length)) {
                                ...
                                installLatestJRE: function (e) {
                                    if (this.isPluginInstalled() && this.isAutoInstallEnabled()) {
                                        var t = !1;
                                        return (
                                            (t = this.isCallbackSupported() ? this.getPlugin().installLatestJRE(e) : this.getPlugin().installLatestJRE()) &&
                                    ...
                                    return "true" == this.EAInstallEnabled && -1 != n.indexOf("win") && null != this.EarlyAccessURL
                                        ? ((this.preInstallJREList = this.getJREs()), null != this.returnPage && (this.myInterval = setInterval("deployJava.poll()", 3e3)), (location.href = this.EarlyAccessURL), !1)
                                        : "MSIE" == i
                                        ? this.IEInstall()
                                        : "Netscape Family" == i && -1 != n.indexOf("win32")
                                        ? this.FFInstall()
                                        : ((location.href = r(
                                              (null != this.returnPage ? "&returnPage=" + this.returnPage : "") + (null != this.locale ? "&locale=" + this.locale : "") + (null != this.brand ? "&brand=" + this.brand : "")
                                          )),
                                          !1);
                                },
                                runApplet: function (e, t, i) {
                                    ...
                                    (null == this.returnPage && (this.returnPage = document.location), null != n)
                                        ? "?" != this.getBrowser()
                                            ? this.versionCheck(i + "+")
                                                ? this.writeAppletTag(e, t)
                                                : this.installJRE(i + "+") && (this.refresh(), (location.href = document.location), this.writeAppletTag(e, t))
                                            : this.writeAppletTag(e, t)
                                        : d("[runApplet()] Invalid minimumVersion argument to runApplet():" + i);
                                },
                                writeAppletTag: function (e, t) {
                                    var i = "<applet ",
                                        n = "",
                                        r = !0;
                                    for (var a in ((null != t && "object" == typeof t) || (t = new Object()), e)) u(o, a.toLowerCase()) ? ((i += " " + a + '="' + e[a] + '"'), "code" == a && (r = !1)) : (t[a] = e[a]);
                                    var l = !1;
                                    for (var s in t) "codebase_lookup" == s && (l = !0), ("object" != s && "java_object" != s && "java_code" != s) || (r = !1), (n += '<param name="' + s + '" value="' + t[s] + '"/>');
                                ...
                                versionCheck: function (e) {
                                    var t = 0,
                                        i = e.match("^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?(\\*|\\+)?$");
                                    if (null != i) {
                                        for (var n = !1, r = !1, a = new Array(), l = 1; l < i.length; ++l) "string" == typeof i[l] && "" != i[l] && ((a[t] = i[l]), t++);
                                        "+" == a[a.length - 1] ? ((n = !(r = !0)), a.length--) : "*" == a[a.length - 1] ? ((n = !(r = !1)), a.length--) : a.length < 4 && (n = !(r = !1));
                                        var s = this.getJREs();
                                        for (l = 0; l < s.length; ++l) if (this.compareVersionToPattern(s[l], a, n, r)) return !0;
                                        return !1;
                                    }
                                    var o = "Invalid versionPattern passed to versionCheck: " + e;
                                    return d("[versionCheck()] " + o), alert(o), !1;
                                },
                                isWebStartInstalled: function (e) {
                                    ...
                                    var t = !1;
                                    return (
                                        null != e.match("^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?$")
                                            ? (t = this.versionCheck(e + "+"))
                                            : (d("[isWebStartInstaller()] Invalid minimumVersion argument to isWebStartInstalled(): " + e), (t = this.versionCheck("1.4.2+"))),
                                        t
                                    );
                                },
                                ...
                                launchWebStartApplication: function (e) {
                                    ...
                                    if (
                                        ("MSIE" == n
                                            ? (i = '<object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" width="0" height="0"><PARAM name="launchjnlp" value="' + e + '"><PARAM name="docbase" value="' + t + '"></object>')
                                            : "Netscape Family" == n && (i = '<embed type="application/x-java-applet;jpi-version=' + this.firefoxJavaVersion + '" width="0" height="0" launchjnlp="' + e + '"docbase="' + t + '" />'),
                                        "undefined" == document.body || null == document.body)
                                    )
                                        document.getElementsByTagName("body")[0].insertAdjacentHTML("afterbegin", i), (document.location = t);
                                    else {
                                ...
                                createWebStartLaunchButtonEx: function (e, t) {
                                    ...
                                    document
                                        ...
                                        .insertAdjacentHTML("afterbegin", '<a href="' + i + '" onMouseOver="window.status=\'\'; return true;"><img src="' + this.launchButtonPNG + '" border="0" /></a>');
                                },
                                ...
                                compareVersionToPattern: function (e, t, i, n) {
                                    ...
                                    if (null != r) {
                                        for (var a = 0, l = new Array(), s = 1; s < r.length; ++s) "string" == typeof r[s] && "" != r[s] && ((l[a] = r[s]), a++);
                                        ...
                                        for (s = 0; s < o; ++s) if (l[s] != t[s]) return !1;
                                ...
                                getBrowser: function () {
                                    if (null == this.browserName) {
                                        ...
                                        d("[getBrowser()] navigator.userAgent.toLowerCase() -> " + e),
                                            -1 != e.indexOf("msie") && -1 == e.indexOf("opera")
                                                ? ((this.browserName = "MSIE"), (this.browserName2 = "MSIE"))
                                                : -1 != e.indexOf("trident") || -1 != e.indexOf("Trident")
                                                ? ((this.browserName = "MSIE"), (this.browserName2 = "MSIE"))
                                                : -1 != e.indexOf("iphone")
                                ...
                                testUsingActiveX: function (e) {
                                    ...
                                    if ("undefined" == typeof ActiveXObject || !ActiveXObject) return d("[testUsingActiveX()] Browser claims to be IE, but no ActiveXObject object?"), !1;
                                    try {
                                ...
                                testUsingMimeTypes: function (e) {
                                    if (!navigator.mimeTypes) return d("[testUsingMimeTypes()] Browser claims to be Netscape family, but no mimeTypes[] array?"), !1;
                                    for (var t = 0; t < navigator.mimeTypes.length; ++t) {
                                        ...
                                        if (null != i && this.compareVersions(i[1], e)) return !0;
                                    }
                                    return !1;
                                },
                                ...
                                IEInstall: function () {
                                    return (
                                        (location.href = r((null != this.returnPage ? "&returnPage=" + this.returnPage : "") + (null != this.locale ? "&locale=" + this.locale : "") + (null != this.brand ? "&brand=" + this.brand : ""))),
                                        !1
                                    );
                                },
                                done: function (e, t) {},
                                ...
                                poll: function () {
                                    this.refresh();
                                    var e = this.getJREs();
                                    0 == this.preInstallJREList.length && 0 != e.length && (clearInterval(this.myInterval), null != this.returnPage && (location.href = this.returnPage)),
                                        0 != this.preInstallJREList.length && 0 != e.length && this.preInstallJREList[0] != e[0] && (clearInterval(this.myInterval), null != this.returnPage && (location.href = this.returnPage));
                                },
                                writePluginTag: function () {
                                    var e = this.getBrowser();
                                    "MSIE" == e
                                        ? document.getElementsByTagName("body")[0].insertAdjacentHTML("afterbegin", '<object classid="clsid:CAFEEFAC-DEC7-0000-0001-ABCDEFFEDCBA" id="deployJavaPlugin" width="0" height="0"></object>')
                                    ...
                                    if (null != navigator.mimeTypes) {
                                        for (var t = 0; t < navigator.mimeTypes.length; t++)
                                            navigator.mimeTypes[t].type == this.mimeType &&
                                                ...
                                                (document.getElementsByTagName("body")[0].insertAdjacentHTML("afterbegin", '<embed id="deployJavaPlugin" type="' + this.mimeType + '" hidden="true" />'), (e = !0));
                                        if (!e)
                                            for (t = 0; t < navigator.mimeTypes.length; t++)
                                                navigator.mimeTypes[t].type == this.oldMimeType &&
                                                    navigator.mimeTypes[t].enabledPlugin &&
                                                    document.getElementsByTagName("body")[0].insertAdjacentHTML("afterbegin", '<embed id="deployJavaPlugin" type="' + this.oldMimeType + '" hidden="true" />');
                                    }
                                },
                            };
                            if ((t.writePluginTag(), null == t.locale)) {
                                var i = null;
                                if (null == i)
                                    try {
            ...
            version_array: function () {
                ...
                return !1 !== e && ((version_array = WIMB_UTIL.decode_java_version(e)), !1 !== version_array && version_array);
            },
            version: function () {
                if (((java_version_array = WIMB.detect.java.version_array()), !1 !== java_version_array)) {
        ...
        local_ipv4_addresses: {
            retrieve: function () {
                if (void 0 !== window.wimb.ipv4_addresses) return window.wimb.ipv4_addresses;
            },
                        ...
                        (function () {
                            var t = function (e) {
                                    if ("" !== ipv4_address && "0.0.0.0" !== ipv4_address) {
                                        for (local_ipv4_address_key in window.wimb.ipv4_addresses) if (window.wimb.ipv4_addresses[local_ipv4_address_key] == ipv4_address) return !0;
                                        window.wimb.ipv4_addresses.push(ipv4_address);
                                    }
                                },
                                i = new e({ iceServers: [] });
                            try {
                                i.createDataChannel("", { reliable: !1 });
                            } catch (e) {}
                            function n(e) {
                                var n = "";
                                return (
                            ...
                            (i.onicecandidate = function (e) {
                                e.candidate && ((ipv4_address = n("a=" + e.candidate.candidate)), t(ipv4_address));
                            }),
                                i.createOffer(
                                    function (e) {
                                        (ipv4_address = n(e.sdp)), t(ipv4_address), i.setLocalDescription(e);
                                    },
                                    function (e) {}
                                );
                        })(),
        ...
        addons: {
            get_all_names: function () {
                return (
                    (addons = []),
                    WIMB.detect.addons.adblock.enabled() && addons.push({ code: "adblocker", name: "Ad blocker", version: null }),
                    WIMB.detect.addons.silverlight.enabled() && addons.push({ code: "silverlight", name: "Microsoft Silverlight", version: WIMB.detect.addons.silverlight.version() }),
                    addons
                );
            },
            adblock: {
            ...
            silverlight: {
                    ...
                    window.Silverlight || (window.Silverlight = {}),
                                ...
                                if (n) {
                                    ...
                                    if (r)
                                        if (null === e) t = !0;
                                            ...
                                            for (var l = a.split("."); 3 < l.length; ) l.pop();
                                            for (; l.length < 4; ) l.push(0);
                                            for (var s = e.split("."); 4 < s.length; ) s.pop();
                                            for (var o, d, u = 0; (o = parseInt(s[u])), (d = parseInt(l[u])), ++u < s.length && o === d; );
                                            o <= d && !isNaN(o) && (t = !0);
                                        }
                                }
                            } catch (e) {
                        ...
                        (Silverlight.WaitForInstallCompletion = function () {
                            if (!Silverlight.isBrowserRestartRequired && Silverlight.onSilverlightInstalled) {
                                ...
                                Silverlight.isInstalled(null) && !Silverlight.__onSilverlightInstalledCalled
                                    ? (Silverlight.onSilverlightInstalled(), (Silverlight.__onSilverlightInstalledCalled = !0))
                                    ...
                                    t && (n = t),
                                        e || (!i && !t)
                                            ? e &&
                                              ...
                                              e.enabledPlugin &&
                                              n.enabledPlugin &&
                                              e.enabledPlugin.description != n.enabledPlugin.description &&
                                              (Silverlight.__installationEventFired || (Silverlight.onRestartRequired(), (Silverlight.__installationEventFired = !0)))
                                            : Silverlight.__installationEventFired || (Silverlight.onUpgradeRequired(), (Silverlight.__installationEventFired = !0));
                                }
                        ...
                        (Silverlight.buildPromptHTML = function (e) {
                            ...
                            return (
                                e.alt
                                    ? (t = e.alt)
                                    : (n || (n = ""),
                                      (t = (t = (t = "<a href='javascript:Silverlight.getSilverlight(\"{1}\");' style='text-decoration: none;'><img src='{2}' alt='Get Microsoft Silverlight' style='border-style: none'/></a>").replace(
                                          "{1}",
                                          n
                                      )).replace("{2}", i + "161376"))),
                                t
                        ...
                        (Silverlight.HtmlAttributeEncode = function (e) {
                            ...
                            for (var n = 0; n < e.length; n++) (96 < (t = e.charCodeAt(n)) && t < 123) || (64 < t && t < 91) || (43 < t && t < 58 && 47 != t) || 95 == t ? (i += String.fromCharCode(t)) : (i = i + "&#" + t + ";");
                            return i;
                        }),
                            ...
                            try {
                                8001 != t.ErrorCode || Silverlight.__installationEventFired
                                    ? 8002 != t.ErrorCode || Silverlight.__installationEventFired
                                        ? 5014 == t.ErrorCode || 2106 == t.ErrorCode
                                            ? Silverlight.__verifySilverlight2UpgradeSuccess(t.getHost()) && (i = !0)
                                            : (i = !0)
                                        : (Silverlight.onRestartRequired(), (Silverlight.__installationEventFired = !0))
                                    : (Silverlight.onUpgradeRequired(), (Silverlight.__installationEventFired = !0));
                            } catch (e) {}
                            return i;
                        }),
                        ...
                        (Silverlight.__verifySilverlight2UpgradeSuccess = function (e) {
                            var t = !1,
                                ...
                                n = null;
                            try {
                                e.IsVersionSupported(i + ".99") ? ((n = Silverlight.onRequiredVersionAvailable), (t = !0)) : (n = e.IsVersionSupported(i + ".0") ? Silverlight.onRestartRequired : Silverlight.onUpgradeRequired),
                                    n && !Silverlight.__installationEventFired && (n(), (Silverlight.__installationEventFired = !0));
                            } catch (e) {}
                            return t;
                        });
                },
                version: function () {
                    ...
                    for (var e = 1; e <= 5; e++) for (var t = 0; t < 10; t++) if (!0 === Silverlight.isInstalled(e + "." + t)) return e + "." + t;
                },
                enabled: function () {
                    return WIMB.detect.addons.silverlight._init(), !!Silverlight.isInstalled("1.0");
                },
            },
        },
    },
    version_check: {
        flash: {
            _latest_version_data_exists: function () {
                return void 0 !== WIMB.version_check.flash._get_latest_flash_version();
            },
            _get_latest_flash_version: function () {
                ...
                if (t) var r = wimb_version_numbers.flash.android;
                    ...
                    if (n) r = wimb_version_numbers.flash.standard;
                    else r = wimb_version_numbers.flash.linux;
                else r = wimb_version_numbers.flash.standard;
                return r;
            },
            is_up_to_date: function () {
                if (!0 === WIMB.version_check.flash._latest_version_data_exists()) {
                    ...
                    for (their_flash_version_fragment_key in e)
                        if (void 0 !== e[their_flash_version_fragment_key] && void 0 !== t[their_flash_version_fragment_key]) {
                            if (parseInt(e[their_flash_version_fragment_key]) == parseInt(t[their_flash_version_fragment_key])) continue;
                            return !(parseInt(e[their_flash_version_fragment_key]) < parseInt(t[their_flash_version_fragment_key]));
                        }
                    return !0;
                }
                return -1;
        ...
        java: {
            _latest_version_data_exists: function () {
                return "undefined" != typeof wimb_version_numbers && void 0 !== wimb_version_numbers.java;
            },
            is_up_to_date: function () {
                if (!0 === WIMB.version_check.java._latest_version_data_exists()) {
                    var e = WIMB.detect.java.version_array(),
                        t = wimb_version_numbers.java;
                    for (their_java_version_fragment_key in ((their_java_version = e.version), (latest_java_version = t.version), their_java_version))
                        if (void 0 !== their_java_version[their_java_version_fragment_key] && void 0 !== latest_java_version[their_java_version_fragment_key]) {
                            ...
                            return !(parseInt(their_java_version[their_java_version_fragment_key]) < parseInt(latest_java_version[their_java_version_fragment_key]));
                        }
                    return (their_java_update = e.update), (latest_java_update = t.update), !(parseInt(their_java_update) < parseInt(latest_java_update));
                }
                return -1;
            },
        },
...
WIMB_UTIL = WIMB_UTIL || {
    ...
    decode_java_version: function (e) {
        ...
        var t = e.split("."),
            i = [],
            n = "";
        for ("1" == t[0] && t[1] <= "4" ? (v = 0) : (v = 1), v = v; v < t.length; v++) {
            !1 !== t[v].search(/^[0-9]+[_]+[0-9]*$/) ? ((fragment_fragments = t[v].split("_")), i.push(parseInt(fragment_fragments[0])), void 0 !== fragment_fragments[1] && (n = parseInt(fragment_fragments[1]))) : (i.push(t[v]), v++);
        }
        return { version: i, update: n };
    },
};
